            ...
            <div className="flex items-center gap-4">
              <div className="relative" ref={menuRef}>
                ...
                >
                  ...
                  <img
                    alt="User profile"
                    className="w-10 h-10 rounded-full border-2 border-white shadow-sm group-hover:border-indigo-100 transition-colors"
                ...
                {isUserMenuOpen && (
                  <div className="absolute right-0 mt-2 w-56 bg-white dark:bg-slate-800 rounded-2xl shadow-2xl border border-slate-200/50 dark:border-slate-700/50 py-2 z-50 overflow-hidden transform origin-top-right transition-all">
                    <Link
                      to="/help"
                    ...
                    <div className="h-[1px] bg-slate-100 dark:bg-slate-700 my-1 mx-4"></div>
                    <button
                      onClick={() => {
                        setIsUserMenuOpen(false);
                        logout();
